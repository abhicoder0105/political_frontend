...
export default function AdminCampaignDetail() {
  ...
  const color = statusColors[campaign.campaign_status] || 'bg-slate-100 text-slate-600'
    ...
    <div className="p-5">
      ...
      <div className="mt-4 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <div className="space-y-4 p-6">
          ...
          <Link to="/admin/campaigns" className="inline-block text-sm font-bold text-orange-600 hover:underline">
            ← वापस अभियान पर
          </Link>
        </div>
      </div>
